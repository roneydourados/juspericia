      ...
      >
        ...
        <div class="mb-6">
          <label class="text-body-2 font-weight-medium mb-3 d-block">
            Para um monitoramento constante de qualidade e usabilidade da
            plataforma, como você nos avalia ?
          </label>
...
const submitFeedback = async () => {
  ...
  try {
    ...
    await feedbackStore.userStoreNpsGeneral({
      monthRef,
      rating: feedbackModel.value.rating ?? 1,
      feedbackText: feedbackModel.value.feedback_text,
    });
