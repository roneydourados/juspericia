  ...
  <CardBlur>
    ...
    <v-card-text>
      <v-table>
        ...
        <tbody>
          <tr v-for="(item, index) in topWorstEvaluations" :key="index">
            <td>
      ...
      <div
        v-if="topWorstEvaluations?.length === 0"
...
defineProps<{
  topWorstEvaluations: WorsEvaluationData[];
}>();
