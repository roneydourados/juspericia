...
[x] - Analisar quando seleciona um laudo para assinar, pegar os dados do médico que o laudo está vinculado e não do usuário logado
[x] - analisar porque não esta gerando comissão de atendente todos os laudos assinados
