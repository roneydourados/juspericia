...
/*
DO $$ BEGIN
 CREATE TYPE "public"."PaymentType" AS ENUM('CREDIT_CARD', 'BOLETO', 'PIX');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."ProfileType" AS ENUM('ADMIN', 'ADVOGADO', 'MEDICO');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "patient_consultations" (
	...
	"antecipation_value" numeric(18, 2) DEFAULT 0 NOT NULL,
	"consultation_value" numeric(18, 2) DEFAULT 0 NOT NULL
);
--> statement-breakpoint
